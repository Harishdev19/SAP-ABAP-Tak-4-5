CLASS zcl_22ee015_debug DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_22ee015_debug IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

    CONSTANTS:
      loan_total      TYPE p DECIMALS 2 VALUE '5000.00',
      spec_repay_mode TYPE c LENGTH 1 VALUE 'Q',
      repayment_month TYPE p DECIMALS 2 VALUE '500.00'.

    DATA:
      loan_remaining TYPE p DECIMALS 2,
    ...
    CASE spec_repay_mode.
      ...
      WHEN 'Q'.
        ...
        DO.
          ...
          APPEND |Paid. Remaining balance is now: { loan_remaining } EUR|
            TO repayment_plan.
